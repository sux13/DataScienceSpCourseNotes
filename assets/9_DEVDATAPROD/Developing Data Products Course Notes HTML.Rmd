...
## ShinyApps.io ([https://www.shinyapps.io](https://www.shinyapps.io))
...
* alternatively, you can click on the menu on the top right hand corner of RStudio: _Project_ --> _New Project_ --> _New Directory_ --> _R Package_ --> fill in package names and details --> automatically generate structure/skeleton of a new R package
...
* when creating a package, generate skeleton by clicking on _Project_ --> _New Project_ --> _New Directory_ --> _R Package_ --> fill in package names and details
...
## Yhat ([http://cloud.yhathq.com/](http://cloud.yhathq.com/))
