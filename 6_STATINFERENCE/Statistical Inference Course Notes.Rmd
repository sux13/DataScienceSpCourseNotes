...
* probability distribution = a function that assigns a number between 0 and 1 to any set of outcomes such that when all outcomes are summed together the total equals 1
...
* for independent events $A$ and $B$, $P(A \:\cup\: B) = P(A) + P(B) - P(A) \times P(B)$
