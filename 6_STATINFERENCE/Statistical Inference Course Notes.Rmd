...
* probability distribution = a function assigns a number between 0 and 1 to any set of outcomes such that when all outcomes are summed together the total equals 1
